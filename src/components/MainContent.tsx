                      ...
                      <div className="bg-white rounded-3xl px-3 py-3">
                        ...
                        <div className="flex justify-end gap-2">
                          ...
                          <button
                            ...
                            className="px-4 py-2 text-sm bg-teal-600 text-white rounded-full hover:bg-teal-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            Send
                          </button>
                        </div>
        ...
        <div className="flex-shrink-0">
          <div className="relative">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 bg-white rounded-lg p-2 sm:p-3 border border-gray-200 shadow-sm">
              ...
              {pinnedAssistant && (
                <div className="flex items-center space-x-2 bg-teal-50 border border-teal-200 rounded-full px-3 py-1 text-sm">
                  <div className="w-4 h-4 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <Bot className="w-2.5 h-2.5 text-teal-600" />
                  </div>
                  <span className="text-teal-700 font-medium">{pinnedAssistant}</span>
                  <button
              ...
              <button 
                ...
                className="p-2 sm:p-3 text-gray-400 hover:text-teal-600 transition-colors flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg"
              >
                {isStreaming ? (
